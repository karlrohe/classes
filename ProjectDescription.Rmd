---
title: "Project description for Stat 479, Spring 2017"
author: "Karl Rohe"
...
You may decide to use "web 2.0" data, or you may use data on US counties.  I'm open to other data sources as well.  


**In the end** (i.e. not yet!), you must ask and answer a question; how are $x$ and $y$ related?  Then, you must develop a "theory" (or a story) for why they are related and use the data to examine your theory.  You should not think of $x$ and $y$ as data, but rather as things that are measurable with data! This idea is easiest to explain with data on US counties.
  
For example, $x$ = "education level" is measured by the US Census beaurau in the ACS at several geographic resolutions, over time.  You might choose $y$ = "age of first marriage," if you could find this data.  Then, there are several "theories" for why these things might be related; different theories imply different directions (+/-).  Perhaps people who choose to go to college are more interested in developing their careers before getting married (-).  Perhaps people who have children in high school do not have the time/money to go to college; instead, they get married (-).  Perhaps college is a great place to meet a spouse (+).  Perhaps only people with good jobs (that require an education) can afford a wedding (+).  These are not listed because they are *good* explainations (or theories), but rather because they possible explainations.  One such explaination should be contained in your thesis statement; your project must test the plausibility of your explaination.  If you are starting with a $y$, you might first identify things that *should* predict it (they don't need to be "interesting").   Explore these predictors.  Can you identify the sorts of observations does your model fails to make good predictions?  What predictors might help?  

If you decide to use data on US counties, Tthere are some restrictions on your final choice of $x$ and $y$. 

1)   $x$ and $y$ must be measurable by freely available data that is    
2)   indexed by (nearly all) zip codes or (nearly all) counties in the United States.  
3)   Every individual in the class must have a unique pair ($x$ and $y$) that they study in their project.   
...
*Please find an $x$ and $y$ that motivate and interest you; from past experience, the best projects have highly motivated questions from interested authors.*
...
The first section (~three paragraphs) is the **introduction**.  It should 

1)   motivate your question to the layperson,
2)   convey your research question (or state it as a hypothesis), and
2)   give a clear thesis statement. 
...
This is quoted [from here](http://vanderbilt.edu/writing/manage/wp-content/files/Thesis-Statements-Script-2014.pdf). Click for more.  
...
While there are no hard limits, your entire document should be roughly [2000 words](http://wordcounttools.com) +/- 500 words.  For example, this document is around 1500 words.  
