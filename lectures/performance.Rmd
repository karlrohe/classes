...
Data Science is not a set of tools.  Data Science (DS) is a performance of [five stances](stances.html).  The performance is an iterative (back and forth) process [through several distinct activities](../diagrams/DataScience.pdf). 
