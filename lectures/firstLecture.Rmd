...
1)  zip codes 
2)  counties, especially using [fips codes](http://www.bls.gov/lau/laucntycur14.txt) (government data)
3)  dates
4)  publicly listed corporations (finance)
5)  physicians $\subset$ medicaid billers. via NPI, a unique 10 digit number  (health services research)
